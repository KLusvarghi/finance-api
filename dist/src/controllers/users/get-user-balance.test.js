...
import { userId, userBalanceResponse, getUserBalanceHttpRequest as baseHttpRequest, invalidUUID, } from '@/test';
describe('GetUserBalanceController', () => {
    let sut;
    let getUserBalanceService;
    ...
    describe('error handling', () => {
        ...
        it('should return 404 if GetUserBalanceService throws UserNotFoundError', async () => {
            jest.spyOn(getUserBalanceService, 'execute').mockRejectedValueOnce(new UserNotFoundError(userId));
            const result = await sut.execute(baseHttpRequest);
