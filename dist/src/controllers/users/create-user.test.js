...
import { createUserParams as params, createUserControllerResponse, createUserHttpRequest as baseHttpRequest, } from '@/test';
describe('CreateUserController', () => {
    ...
    describe('error handling', () => {
        ...
        it('should return 400 if CreateUserService throws EmailAlreadyExistsError', async () => {
            // arrange
            jest.spyOn(createUserService, 'execute').mockRejectedValueOnce(new EmailAlreadyExistsError(params.email));
            // act
            const result = await sut.execute(baseHttpRequest);
            // assert
    ...
    describe('success cases', () => {
        it('should create a new user successfully and return 201', async () => {
            ...
            expect(result.body?.data).toMatchObject(createUserControllerResponse);
        });
