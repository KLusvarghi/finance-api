...
export class PostgresGetUserBalanceRepository {
    async execute(userId) {
        ...
        const [expensesResult, earningsResult, investmentsResult] = await Promise.all([
        ...
        const totalExpenses = Number(expensesResult._sum.amount) || new Prisma.Decimal(0);
        const totalEarnings = Number(earningsResult._sum.amount) || new Prisma.Decimal(0);
        const totalInvestments = Number(investmentsResult._sum.amount) || new Prisma.Decimal(0);
