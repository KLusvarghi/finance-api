import { createTestUser, updateUserRepositoryResponse as fakeUser, updateUserParams as params, } from '@/test';
...
describe('PostgresUpdateUserRepository', () => {
    ...
    describe('error handling', () => {
        it('should throw an error if Prisma throws', async () => {
            // arrange
            jest.spyOn(prisma.user, 'update').mockRejectedValueOnce(new Error('Prisma error'));
            // act
