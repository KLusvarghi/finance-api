...
import { transactionId, deleteTransactionServiceResponse, deleteTransactionRepositoryResponse, } from '@/test';
describe('DeleteTransactionService', () => {
    ...
    beforeEach(() => {
        const { sut: service, deleteTransactionRepository: deleteTransactionRepositoryStub, } = makeSut();
        sut = service;
