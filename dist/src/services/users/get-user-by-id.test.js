...
import { userId, getUserByIdServiceResponse, getUserByIdRepositoryResponse, } from '@/test';
describe('GetUserByIdService', () => {
    ...
    beforeEach(() => {
        const { sut: service, getUserByIdRepository: getUserByIdRepositoryStub, } = makeSut();
        sut = service;
    ...
    describe('error handling', () => {
        ...
        it('should throw if GetUserByIdRepository throws', async () => {
            // arrange
            jest.spyOn(getUserByIdRepository, 'execute').mockRejectedValueOnce(new UserNotFoundError(userId));
            // act
            const promise = sut.execute(userId);
            // assert
