...
import { createUserParams, createUserServiceResponse, createUserRepositoryResponse, } from '@/test';
describe('CreateUserService', () => {
    ...
    const makeSut = () => {
        ...
        const sut = new CreateUserService(createUserRepository, getUserByEmailRepository, idGeneratorAdapter, passwordHasherAdapter);
        return {
            sut,
    ...
    beforeEach(() => {
        const { sut: service, createUserRepository: createUserRepositoryStub, getUserByEmailRepository: getUserByEmailRepositoryStub, passwordHasherAdapter: passwordHasherAdapterStub, idGeneratorAdapter: idGeneratorAdapterStub, } = makeSut();
        sut = service;
    ...
    describe('error handling', () => {
        it('should throw an EmailAlreadyExistsError if getUserByEmailRepository returns a user', () => {
            ...
            jest.spyOn(getUserByEmailRepository, 'execute').mockResolvedValueOnce(createUserRepositoryResponse);
            // act
            ...
            expect(promise).rejects.toThrow(new EmailAlreadyExistsError(createUserParams.email));
        });
    ...
    describe('validations', () => {
        it('should call CreateUserRepository with correct params', async () => {
            ...
            // assert
            expect(executeSpy).toHaveBeenCalledWith(createUserRepositoryResponse);
