...
export class UpdateUserService {
    ...
    constructor(getUserByEmailRepository, updateUserRepository, passwordHasher, getUserByIdRepository) {
    ...
    async execute(userId, updateUserParams) {
        ...
        if (updateUserParams.email) {
            const userWithProvidedEmail = await this.getUserByEmailRepository.execute(updateUserParams.email);
        ...
        if (updateUserParams.password) {
            const hashPassword = await this.passwordHasher.execute(updateUserParams.password);
